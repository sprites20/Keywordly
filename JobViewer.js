  ...
  return (
    <div className="job-viewer-container">
      ...
      <p className="job-viewer-text">
        <span className="job-viewer-label"><b>Company:</b></span> {job?.company_name || "N/A"}
      </p>
  
      <p className="job-viewer-text">
        <span className="job-viewer-label"><b>Location:</b></span> {job?.location || "N/A"}
      </p>
  
      <p className="job-viewer-text">
        <span className="job-viewer-label"><b>Description:</b></span>{" "}
        <span
      ...
      <p className="job-viewer-text">
        <span className="job-viewer-label"><b>Skills:</b></span>{" "}
        <span
          dangerouslySetInnerHTML={{
      ...
      <p className="job-viewer-text">
        <span className="job-viewer-label"><b>Work Type:</b></span> {job?.work_type || "N/A"}
      </p>
  
      <p className="job-viewer-text">
        <span className="job-viewer-label"><b>Salary:</b></span>{" "}
        {job?.min_salary && job?.max_salary
          ? `${job.min_salary}–${job.max_salary} ${job?.currency || ""}`
          : "Not specified"}
      </p>
      <p className="job-viewer-text">
        <span className="job-viewer-label"><b>Job Link:</b></span>{' '}
        {job?.job_posting_url ? (
